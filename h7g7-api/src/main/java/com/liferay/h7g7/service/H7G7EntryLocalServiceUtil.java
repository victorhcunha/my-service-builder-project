...
/**
 * Provides the local service utility for H7G7Entry. This utility wraps
 * <code>com.liferay.h7g7.service.impl.H7G7EntryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class H7G7EntryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.h7g7.service.impl.H7G7EntryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static H7G7Entry addH7G7Entry(H7G7Entry h7g7Entry) {
		return getService().addH7G7Entry(h7g7Entry);
	}
	 ...
	 */
	public static H7G7Entry createH7G7Entry(long h7g7EntryId) {
		return getService().createH7G7Entry(h7g7EntryId);
	}
	 ...
	 */
	public static H7G7Entry deleteH7G7Entry(H7G7Entry h7g7Entry) {
		return getService().deleteH7G7Entry(h7g7Entry);
	}
	 ...
	 */
	public static H7G7Entry deleteH7G7Entry(long h7g7EntryId)
		throws PortalException {

		return getService().deleteH7G7Entry(h7g7EntryId);
	}
	...
	public static H7G7Entry fetchH7G7Entry(long h7g7EntryId) {
		return getService().fetchH7G7Entry(h7g7EntryId);
	}
	 ...
	 */
	public static List<H7G7Entry> getH7G7Entries(int start, int end) {
		return getService().getH7G7Entries(start, end);
	}
	 ...
	 */
	public static int getH7G7EntriesCount() {
		return getService().getH7G7EntriesCount();
	}
	 ...
	 * @throws PortalException if a h7g7 entry with the primary key could not be found
	 */
	public static H7G7Entry getH7G7Entry(long h7g7EntryId)
		throws PortalException {

		return getService().getH7G7Entry(h7g7EntryId);
	}
	 ...
	 */
	public static H7G7Entry updateH7G7Entry(H7G7Entry h7g7Entry) {
		return getService().updateH7G7Entry(h7g7Entry);
	}

	public static H7G7EntryLocalService getService() {
		return _service;
	}

	private static volatile H7G7EntryLocalService _service;
