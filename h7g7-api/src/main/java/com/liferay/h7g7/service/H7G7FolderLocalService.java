...
/**
 * Provides the local service interface for H7G7Folder. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see H7G7FolderLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface H7G7FolderLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.h7g7.service.impl.H7G7FolderLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the h7g7 folder local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link H7G7FolderLocalServiceUtil} if injection and service tracking are not available.
	 */
