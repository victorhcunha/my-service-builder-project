...
/**
 * The persistence utility for the h7g7 entry service. This utility wraps <code>com.liferay.h7g7.service.persistence.impl.H7G7EntryPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see H7G7EntryPersistence
 * @generated
 */
public class H7G7EntryUtil {
	 ...
	 */
	public static void clearCache(H7G7Entry h7g7Entry) {
		getPersistence().clearCache(h7g7Entry);
	}
	 ...
	 */
	public static Map<Serializable, H7G7Entry> fetchByPrimaryKeys(
	 ...
	 */
	public static List<H7G7Entry> findWithDynamicQuery(
	 ...
	 */
	public static H7G7Entry update(H7G7Entry h7g7Entry) {
		return getPersistence().update(h7g7Entry);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static H7G7Entry update(
		H7G7Entry h7g7Entry, ServiceContext serviceContext) {

		return getPersistence().update(h7g7Entry, serviceContext);
	}
	 ...
	 */
	public static List<H7G7Entry> findByH7G7FolderId(long h7g7FolderId) {
		return getPersistence().findByH7G7FolderId(h7g7FolderId);
	}
	 ...
	 */
	public static List<H7G7Entry> findByH7G7FolderId(
		long h7g7FolderId, int start, int end) {

		return getPersistence().findByH7G7FolderId(h7g7FolderId, start, end);
	}
	...
	public static List<H7G7Entry> findByH7G7FolderId(
		...
		return getPersistence().findByH7G7FolderId(
	...
	public static List<H7G7Entry> findByH7G7FolderId(
		...
		return getPersistence().findByH7G7FolderId(
			h7g7FolderId, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 */
	public static H7G7Entry findByH7G7FolderId_First(
			long h7g7FolderId, OrderByComparator<H7G7Entry> orderByComparator)
		throws com.liferay.h7g7.exception.NoSuchH7G7EntryException {

		return getPersistence().findByH7G7FolderId_First(
	 ...
	 */
	public static H7G7Entry fetchByH7G7FolderId_First(
		long h7g7FolderId, OrderByComparator<H7G7Entry> orderByComparator) {

		return getPersistence().fetchByH7G7FolderId_First(
			h7g7FolderId, orderByComparator);
	}
	 ...
	 * @throws NoSuchH7G7EntryException if a matching h7g7 entry could not be found
	 */
	public static H7G7Entry findByH7G7FolderId_Last(
			long h7g7FolderId, OrderByComparator<H7G7Entry> orderByComparator)
		throws com.liferay.h7g7.exception.NoSuchH7G7EntryException {

		return getPersistence().findByH7G7FolderId_Last(
			h7g7FolderId, orderByComparator);
	}
	 ...
	 */
	public static H7G7Entry fetchByH7G7FolderId_Last(
		long h7g7FolderId, OrderByComparator<H7G7Entry> orderByComparator) {

		return getPersistence().fetchByH7G7FolderId_Last(
			h7g7FolderId, orderByComparator);
	}
	 ...
	 */
	public static H7G7Entry[] findByH7G7FolderId_PrevAndNext(
			long h7g7EntryId, long h7g7FolderId,
			OrderByComparator<H7G7Entry> orderByComparator)
		throws com.liferay.h7g7.exception.NoSuchH7G7EntryException {

		return getPersistence().findByH7G7FolderId_PrevAndNext(
			h7g7EntryId, h7g7FolderId, orderByComparator);
	}
	 ...
	 * @param h7g7FolderId the h7g7 folder ID
	 */
	public static void removeByH7G7FolderId(long h7g7FolderId) {
		getPersistence().removeByH7G7FolderId(h7g7FolderId);
	}
	 ...
	 */
	public static int countByH7G7FolderId(long h7g7FolderId) {
		return getPersistence().countByH7G7FolderId(h7g7FolderId);
	}
	 ...
	 * @throws NoSuchH7G7EntryException if a matching h7g7 entry could not be found
	 */
	public static H7G7Entry findByKey(String key)
		throws com.liferay.h7g7.exception.NoSuchH7G7EntryException {
	 ...
	 */
	public static H7G7Entry fetchByKey(String key) {
	 ...
	 * @return the matching h7g7 entry, or <code>null</code> if a matching h7g7 entry could not be found
	 */
	public static H7G7Entry fetchByKey(String key, boolean useFinderCache) {
	 ...
	 */
	public static H7G7Entry removeByKey(String key)
		throws com.liferay.h7g7.exception.NoSuchH7G7EntryException {
	 ...
	 * @return the matching h7g7 entries
	 */
	public static List<H7G7Entry> findByName(String name) {
	 ...
	 * @return the range of matching h7g7 entries
	 */
	public static List<H7G7Entry> findByName(String name, int start, int end) {
	 ...
	 * @return the ordered range of matching h7g7 entries
	 */
	public static List<H7G7Entry> findByName(
	 ...
	 * @throws NoSuchH7G7EntryException if a matching h7g7 entry could not be found
	 */
	public static H7G7Entry findByName_First(
	 ...
	 * @return the first matching h7g7 entry, or <code>null</code> if a matching h7g7 entry could not be found
	 */
	public static H7G7Entry fetchByName_First(
		String name, OrderByComparator<H7G7Entry> orderByComparator) {
	 ...
	 * @throws NoSuchH7G7EntryException if a matching h7g7 entry could not be found
	 */
	public static H7G7Entry findByName_Last(
			String name, OrderByComparator<H7G7Entry> orderByComparator)
		throws com.liferay.h7g7.exception.NoSuchH7G7EntryException {
	 ...
	 * @return the last matching h7g7 entry, or <code>null</code> if a matching h7g7 entry could not be found
	 */
	public static H7G7Entry fetchByName_Last(
		String name, OrderByComparator<H7G7Entry> orderByComparator) {
	 ...
	 * @throws NoSuchH7G7EntryException if a h7g7 entry with the primary key could not be found
	 */
	public static H7G7Entry[] findByName_PrevAndNext(
			long h7g7EntryId, String name,
			OrderByComparator<H7G7Entry> orderByComparator)
		throws com.liferay.h7g7.exception.NoSuchH7G7EntryException {

		return getPersistence().findByName_PrevAndNext(
			h7g7EntryId, name, orderByComparator);
	}
	 ...
	 * @throws NoSuchH7G7EntryException if a matching h7g7 entry could not be found
	 */
	public static H7G7Entry findByH_D_N(
			long h7g7FolderId, String description, String name)
		throws com.liferay.h7g7.exception.NoSuchH7G7EntryException {

		return getPersistence().findByH_D_N(h7g7FolderId, description, name);
	}
	 ...
	 * @return the matching h7g7 entry, or <code>null</code> if a matching h7g7 entry could not be found
	 */
	public static H7G7Entry fetchByH_D_N(
		long h7g7FolderId, String description, String name) {

		return getPersistence().fetchByH_D_N(h7g7FolderId, description, name);
	}
	...
	public static H7G7Entry fetchByH_D_N(
		...
		return getPersistence().fetchByH_D_N(
			h7g7FolderId, description, name, useFinderCache);
	}
	 ...
	 * @return the h7g7 entry that was removed
	 */
	public static H7G7Entry removeByH_D_N(
			long h7g7FolderId, String description, String name)
		throws com.liferay.h7g7.exception.NoSuchH7G7EntryException {

		return getPersistence().removeByH_D_N(h7g7FolderId, description, name);
	}
	...
	public static int countByH_D_N(
		...
		return getPersistence().countByH_D_N(h7g7FolderId, description, name);
	}
	 ...
	 */
	public static void cacheResult(H7G7Entry h7g7Entry) {
		getPersistence().cacheResult(h7g7Entry);
	}
	 ...
	 */
	public static void cacheResult(List<H7G7Entry> h7g7Entries) {
		getPersistence().cacheResult(h7g7Entries);
	}
	 ...
	 */
	public static H7G7Entry create(long h7g7EntryId) {
		return getPersistence().create(h7g7EntryId);
	}
	 ...
	 * @throws NoSuchH7G7EntryException if a h7g7 entry with the primary key could not be found
	 */
	public static H7G7Entry remove(long h7g7EntryId)
		throws com.liferay.h7g7.exception.NoSuchH7G7EntryException {

		return getPersistence().remove(h7g7EntryId);
	}

	public static H7G7Entry updateImpl(H7G7Entry h7g7Entry) {
		return getPersistence().updateImpl(h7g7Entry);
	}
	 ...
	 * @throws NoSuchH7G7EntryException if a h7g7 entry with the primary key could not be found
	 */
	public static H7G7Entry findByPrimaryKey(long h7g7EntryId)
		throws com.liferay.h7g7.exception.NoSuchH7G7EntryException {

		return getPersistence().findByPrimaryKey(h7g7EntryId);
	}
	 ...
	 */
	public static H7G7Entry fetchByPrimaryKey(long h7g7EntryId) {
		return getPersistence().fetchByPrimaryKey(h7g7EntryId);
	}
	 ...
	 */
	public static List<H7G7Entry> findAll() {
	 ...
	 */
	public static List<H7G7Entry> findAll(int start, int end) {
	...
	public static H7G7EntryPersistence getPersistence() {
		return _persistence;
	}

	private static volatile H7G7EntryPersistence _persistence;
