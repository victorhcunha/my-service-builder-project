...
/**
 * The persistence interface for the h7g7 folder service.
 *
 * <p>
 ...
 */
@ProviderType
public interface H7G7FolderPersistence extends BasePersistence<H7G7Folder> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link H7G7FolderUtil} to access the h7g7 folder persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<H7G7Folder> h7g7Folders);
	 ...
	 */
	public java.util.List<H7G7Folder> findAll();
	 ...
	 */
	public java.util.List<H7G7Folder> findAll(int start, int end);
	...
	public java.util.List<H7G7Folder> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<H7G7Folder>
			orderByComparator);
