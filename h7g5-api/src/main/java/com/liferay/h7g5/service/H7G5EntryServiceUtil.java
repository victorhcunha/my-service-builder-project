...
public class H7G5EntryServiceUtil {
	...
	public static H7G5Entry addMyCustomH7G5Entry(
		...
		return getService().addMyCustomH7G5Entry(description, name);
	}

	public static H7G5Entry addMyCustomH7G5EntryWithPermissionCheck(
			String description, String name)
		throws PortalException {

		return getService().addMyCustomH7G5EntryWithPermissionCheck(
			description, name);
	}
